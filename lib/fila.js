...
function finalizar(id) {
    ...
    var ajaxurl = 'finalizar.php', data = {
        "id": id
    };
...
function makeid(length) {
 ...
 function confirmar(id) {
  ...
  function deletar(id) {
    ...
    var ajaxurl = 'excluir_fila.php', data = {
        "id": id
    };
  ...
  function logout() {
    ...
    var ajaxurl = 'controller_logout.php';
  ...
  function alterar_limitador(limitador) {
    ...
    var ajaxurl = 'controller_limitador.php', data = {
        "limitador": limitador
    };
